...
def plot_density(grid: list, density: list[list], **kwargs) -> None:
    ...
    plt.savefig(f"PLOTS/{kwargs['MAIN_TITLE']}.png")
...
def main(MODE: str) -> None:
    ...
    # PROBLEM = "Stationary Contact Wave"
    ...
    # PROBLEM = "TORO-3"
    # PROBLEM = "TORO-4"
    # PROBLEM = "Shock Density Wave Interaction"
    # PROBLEM = "Shock Entropy Wave Interaction"
    ...
    plot_density(grid, density, MAIN_TITLE=PROBLEM)
