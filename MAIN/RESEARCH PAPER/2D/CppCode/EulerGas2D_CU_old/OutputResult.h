...
namespace OutputResult{
    ...
    void write_grids(string mode, const vector<double>& gridX, const vector<double>& gridY);
    ...
    void write_matrix(string mode, string var, const vector< vector<double> >& matrix);
}
...
void OutputResult::write_grids(string mode, const vector<double>& gridX, const vector<double>& gridY){
    string file_name;
